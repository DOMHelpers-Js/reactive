...
export default defineConfig({
  ...
  themeConfig: {
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/giovanni1707/DOMHelpers-Reactive",
      },
    ],
    ...
    nav: [
      ...
      { text: "CDN", link: "/cdn/ALL-CDN-LINKS" },
      { text: "Fundamentals", link: "/reactive-state/state" },
      { text: "DOM Integration", link: "/dom-integration/what-is-dom-integration" },
    ...
    sidebar: {
      ...
      "/cdn/": [
        {
          ...
          collapsed: false,
          items: [
            { text: "All CDN Links", link: "/cdn/ALL-CDN-LINKS" },
            { text: "Module Dependencies", link: "/cdn/MODULE-DEPENDENCIES" },
            { text: "Loading Approaches", link: "/cdn/loading-approaches" },
            { text: "Module Loader", link: "/cdn/module-loader" },
          ],
        },
      ],
      ...
      "/dom-integration/": [
        {
          text: "DOM Integration",
          collapsed: false,
          items: [
            { text: "What Is DOM Integration", link: "/dom-integration/what-is-dom-integration" },
            { text: "Elements Namespace", link: "/dom-integration/elements-namespace" },
            { text: "Collections Namespace", link: "/dom-integration/collections-namespace" },
            { text: "Selector Namespace", link: "/dom-integration/selector-namespace" },
          ],
        },
      ],
      ...
      "/creator/": [
        {
          ...
          items: [
            ...
            { text: "Contributing", link: "/creator/contributing" },
          ],
        },
      ],
      ...
      "/reactivePlus/": [
...

        {
          ...
          items: [
            {
              text: "Elements Namespace",
              link: "/reactivePlus/elements-namespace",
            },
            {
              text: "ClassName, TagName & Name",
              link: "/reactivePlus/collections-namespace",
            },
            {
              text: "query & queryAll",
              link: "/reactivePlus/selector-namespace",
            },
          ],
        },
